...
const uint32_t DEPOSIT_MAX_TERM					= 1 * 2 * 21900; // ~1 year
...
const uint64_t CRYPTONOTE_MEMPOOL_TX_LIVETIME			= (6 * 6 * 12); // seconds, 12 hours
const uint64_t CRYPTONOTE_MEMPOOL_TX_FROM_ALT_BLOCK_LIVETIME	= (6 * 6 * 2); // seconds, 1 day
...
const char     GENESIS_COINBASE_TX_HEX[]			= "010a01ff000180a0b787e905029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd08807121010bd75d9fc96b076efdd57afbe504d0b7d2d92fa66dc0816edebce914418cc713";
